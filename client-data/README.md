# Sample data: public company financial documents

These are **publicly published company financial documents** — quarterly earnings releases, press releases, and public regulatory filings — collected to serve as realistic sample data for the hackathon app.
...
> **Note on the folder name:** despite being called `client-data`, none of these are Aberdeen client documents or Aberdeen engagements. They are public filings and press releases from unrelated public companies, used purely as sample input while building.

Most of these cover **Q2 2026**. Three are different, and are flagged in the table below — worth knowing if you are writing code that assumes every document is a Q2 2026 earnings release.
...
## The three files that aren't standard Q2 2026 earnings releases
...
Eleven files are PDF; one (`Loma Linda University Health july 2026 release.html`) is a saved HTML web page. Several of the PDFs are print-to-PDF captures of investor-relations web pages, so they carry web furniture such as cookie banners, navigation menus, and social-share links in the extracted text. Expect to strip that out when parsing.
